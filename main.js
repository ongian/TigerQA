...
const QAPage = async(campaignID) => {
    ...
    try{
        ...
        for(i = 0; i < eachProduct.length; i++){
            ...
            EDPs.push(skuData)
            if(eachProduct.length > featuredProductEDP.length && eachProduct.length > automatedEDP.length){
        ...
        if(featuredProductEDP.length > 0){
            for(i = 0; i < featuredProductEDP.length; i++){
                ...
                if(featuredProductEDP.length > eachProduct.length && featuredProductEDP.length > automatedEDP.length){
